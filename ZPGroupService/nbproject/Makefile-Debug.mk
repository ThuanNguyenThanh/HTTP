...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/zpgroupservice: /usr/local/lib/libhiredis.a
...
${OBJECTDIR}/ZApiCalcHandler.o: ZApiCalcHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DWRITE_LOG -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ZApiCalcHandler.o ZApiCalcHandler.cpp
...
${OBJECTDIR}/ZRedisProcess.o: ZRedisProcess.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DWRITE_LOG -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ZRedisProcess.o ZRedisProcess.cpp
